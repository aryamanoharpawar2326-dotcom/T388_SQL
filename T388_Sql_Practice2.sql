...
alter table employee add title varchar(23) first;
alter table employee modify fullname varchar(20);
alter table employee change column location address varchar(20);
update employee set address = "thane";
select * from employee;
desc employee;
alter table employee drop address, drop bonus, drop title;
INSERT INTO Employee values
(1001,"John Doe","IT",35000,"Male",25), 
(1002, 'Mary Smith', 'HR', 45000, 'Female', 27), 
(1003, 'James Brown', 'Finance', 50000, 'Male', 28), 
...
alter table employee add title varchar(20) first;
alter table employee add bonus float after salary;
